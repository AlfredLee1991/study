...
/**
 * 功能描述：下面的打印代码没有设置打印区域，默认为打印纸张的区域和边距，比如我们一般用的A4纸，打印的起点X和Y坐标则是72，72。无区域设置的代码.
 * <br/>
 * 
 * #date： 2017年6月15日 下午3:55:47<br/>
 * #author 李旭<br/>
 * #since 1.0.0<br/>
 */
...
//        String str = "中华民族是勤劳、勇敢和富有智慧的伟大民族。";
        ...
        case 0:
            ...
            Image src = Toolkit.getDefaultToolkit().getImage("d://test.gif");
            g2.drawImage(src, (int) x, (int) y, c);
            int img_Height = src.getHeight(c);
            int img_width = src.getWidth(c);

            
            Image src2 = Toolkit.getDefaultToolkit().getImage("d://test.gif");
            g2.drawImage(src2, (int) x, (int) y, c);
            int img_Height2 = src2.getHeight(c);
            int img_width2 = src2.getWidth(c);
...
//                    (int) (y + 1 * heigth + img_Height + 10));
            ...
            g2.drawImage(src2, (int) x, (int) (y + 1 * heigth + img_Height2 + 11), c);
            // -2- 直接构造TextLayout打印
            /*
    ...
    public static void main(String[] args) {
        ...
        job.setPrintable(new PrintTest());// 设置打印类
        try {
